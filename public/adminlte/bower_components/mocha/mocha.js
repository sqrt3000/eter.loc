...
/* See LICENSE files for terms of use */
  ...
  return {
    ...
    createPatch: function(fileName, oldStr, newStr, oldHeader, newHeader) {
      ...
      function eofNL(curRange, i, current) {
        ...
        // Figure out if this is the last line for the given files and missing NL
        if (!/\n$/.test(current.value) && (isLast || isLastOfType)) {
          curRange.push('\\ No newline at end of files');
        }
      }
...
/**
 * Map jscoverage data for a single source files
 * to a JSON structure suitable for reporting.
 *
 * @param {String} filename name of the source files
 ...
 * and invoke `fn(files)` on modification.
 *
 * @param {Array} files
 * @param {Function} fn
 * @api private
