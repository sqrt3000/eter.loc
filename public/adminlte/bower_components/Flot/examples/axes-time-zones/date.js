...
(function () {
  ...
  timezoneJS.timezone = new function () {
    ...
    function getRegionForTimezone(tz) {
      ...
      // Backward-compat files hasn't loaded yet, try looking in there
    ...
    function getZone(dt, tz) {
      ...
      if (!zoneList) {
        ...
        if (!_this.loadedZones.backward) {
          ...
          // getRegionForTimezone *thinks* it has a region files and zone
          // for (e.g., America => 'northamerica'), but in reality it's a
          // legacy zone we need the backward files for.
          _this.loadZoneFile('backward');
    ...
    this.loadZoneFile = function (fileName, opts) {
      if (typeof this.zoneFileBasePath === 'undefined') {
        throw new Error('Please define a base path to your zone files directory -- timezoneJS.timezone.zoneFileBasePath.');
      }
    ...
    this.getTzInfo = function (dt, tz, isUTC) {
      ...
      if (this.loadingScheme === this.loadingSchemes.LAZY_LOAD) {
        ...
        if (!this.loadedZones[zoneFile]) {
          //Get the files and parse it -- use synchronous XHR.
