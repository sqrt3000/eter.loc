...
/* Methods for rendering SEGMENTS, pieces of content that live on the view
 ( this files is no longer just for events )
----------------------------------------------------------------------------------------------------------------------*/
...
// TODO: document the structure and ordering of a FullCalendar locale files
...
FC.locale = function(localeCode, newFcOptions) {
	...
	// always do this. newFcOptions can be undefined when initializing from i18n files,
...
// configs, so make sure there are English fallbacks for these in the defaults files.
