...
/** Constructor. Parameter $image should be:
  ...
  *   4. A filename string. Get image form files.
...
/** Checks if files is an image. This static method should be implemented into
...
/** Should output the image. Second parameter is used to pass some options like
  *   'files' - if is set, the output will be written to a files
