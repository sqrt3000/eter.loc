...
/** Cache a files. The $type parameter might define the MIME type of the files
  * or path to magic files to autodetect the MIME type. If you skip $type
  * parameter the method will try with the default magic files. Autodetection
  * of MIME type requires Fileinfo PHP extension used in files::getMimeType()
  * @param string $file
  * @param string $type
