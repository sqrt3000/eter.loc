...
/** Russian localization files for KCFinder
...
$lang = array(
    ...
    "Cannot move uploaded files to target folder." => "Невозможно переместить загруженный файл в папку назначения.",
    "Unknown error." => "Неизвестная ошибка.",
    "The uploaded files exceeds {size} bytes." => "Загруженный файл превышает размер {size} байт.",
    "The uploaded files was only partially uploaded." => "Загруженный файл был загружен только частично.",
    "No files was uploaded." => "Файл не был загружен",
    "Missing a temporary folder." => "Временная папка не существует.",
    "Failed to write files." => "Невозможно записать файл.",
    "Denied files extension." => "Файлы этого типа запрещены для загрузки.",
    ...
    "Incorrect .htaccess files. Cannot rewrite it!" => "Неправильный файл .htaccess. Невозможно перезаписать!",
    ...
    "Please enter new files name." => "Укажите новое имя файла",
    "Unallowable characters in files name." => "Недопустимые символны в имени файла.",
    "File name shouldn't begins with '.'" => "Имя файла не может начинаться с '.'",
    "Are you sure you want to delete this files?" => "Вы уверены, что хотите удалить этот файл?",
    ...
    "The files '{files}' does not exist." => "Файл '{files}' не существует.",
    "Cannot read '{files}'." => "Невозможно прочитать файл '{files}'.",
    "Cannot copy '{files}'." => "Невозможно скопировать файл '{files}'.",
    "Cannot move '{files}'." => "Невозможно переместить файл '{files}'.",
    "Cannot delete '{files}'." => "Невозможно удалить файл '{files}'.",
    ...
    "This files is already added to the Clipboard." => "Этот файл уже добавлен в буфер обмена.",
    ...
    "A files or folder with that name already exists." => "Файл или папка с таким именем уже существуют.",
    ...
    "New files name:" => "Новое имя файла:",
    "Upload" => "Загрузить",
    "Refresh" => "Обновить",
    "Settings" => "Установки",
    "Maximize" => "Развернуть",
    ...
    "Uploading files..." => "Загрузка файла...",
    ...
    "Uploading files {number} of {count}... {progress}" => "Загрузка {number} файла из {count}... {progress}",
