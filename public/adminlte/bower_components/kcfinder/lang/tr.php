...
/** Turkish localization files for KCFinder
...
$lang = array(
    ...
    "Cannot move uploaded files to target folder." => "Yüklenilen dosyalar hedef klasöre taşınamıyor.",
    "Unknown error." => "Bilinmeyen hata.",
    "The uploaded files exceeds {size} bytes." => "Gönderilen dosya boyutu, maksimum dosya boyutu limitini ({size} byte) aşıyor.",
    "The uploaded files was only partially uploaded." => "Dosyanın sadece bir kısmı yüklendi. Yüklemeyi tekrar deneyin.",
    "No files was uploaded." => "Dosya yüklenmedi.",
    "Missing a temporary folder." => "Geçici dosya klasörü bulunamıyor. Klasörü kontrol edin.",
    "Failed to write files." => "Dosya yazılamıyor. Klasör yetkilerini kontrol edin.",
    "Denied files extension." => "Yasaklanmış dosya türü.",
    ...
    "Incorrect .htaccess files. Cannot rewrite it!" => "Hatalı .htaccess dosyası. Dosyaya yeniden yazılamıyor.",
    ...
    "Please enter new files name." => "Lütfen yeni dosya adını girin.",
    "Unallowable characters in files name." => "Dosya adında izin verilmeyen karakter kullandınız.",
    "File name shouldn't begins with '.'" => "Dosya adı '.' ile başlayamaz.",
    "Are you sure you want to delete this files?" => "Dosyayı silmek istediğinizden emin misiniz?",
    ...
    "The files '{files}' does not exist." => "'{files}' dosyası yok.",
    "Cannot read '{files}'." => "'{files}' dosyası okunamıyor.",
    "Cannot copy '{files}'." => "'{files}' dosyası kopyalanamıyor.",
    "Cannot move '{files}'." => "'{files}' dosyası taşınamıyor.",
    "Cannot delete '{files}'." => "'{files}' dosyası silinemiyor.",
    "Cannot delete the folder." => "Klasör silinemiyor.",
    "Click to remove from the Clipboard" => "Panodan çıkarmak için tıklayın",
    "This files is already added to the Clipboard." => "Bu dosya zaten panoya eklenmiş.",
    ...
    "A files or folder with that name already exists." => "Bu isimde bir klasör yada dosya zaten var.",
    ...
    "Date" => "Tarih",
    "Descending" => "Azalarak",
    "Uploading files..." => "Dosya Gönderiliyor...",
    ...
    "Uploading files {number} of {count}... {progress}" => "{number} / {count} dosya yükleniyor... {progress}",
