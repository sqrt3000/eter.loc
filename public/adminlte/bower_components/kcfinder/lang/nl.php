...
/** Dutch localization files for KCFinder
...
$lang = array(
    ...
    "Cannot move uploaded files to target folder." => "Het te uploaden bestand kon niet naar de doelmap verplaatst worden.",
    "Unknown error." => "Onbekende foutmelding.",
    "The uploaded files exceeds {size} bytes." => "De bestandsgrootte van het bestand overschrijdt de limiet {size} bytes.",
    "The uploaded files was only partially uploaded." => "Het te uploaden bestand is slechts gedeeltelijk geupload.",
    "No files was uploaded." => "Er is geen bestand geupload.",
    "Missing a temporary folder." => "Een tijdelijke map ontbreekt.",
    "Failed to write files." => "Poging tot schrijven van bestand is mislukt.",
    "Denied files extension." => "De extensie van dit bestand is niet toegestaan.",
    ...
    "Incorrect .htaccess files. Cannot rewrite it!" => "Verkeerd .htaccess bestand. Bestand kan niet herschreven worden!",
    ...
    "Please enter new files name." => "Vul a.u.b. een nieuwe bestandsnaam in.",
    "Unallowable characters in files name." => "Er zijn niet toegestane karakters gebruikt in de bestandsnaam.",
    "File name shouldn't begins with '.'" => "Een bestandsnaam mag niet met '.' beginnen.",
    "Are you sure you want to delete this files?" => "Weet u zeker dat u dit bestand wilt verwijderen?",
    ...
    "The files '{files}' does not exist." => "Het bestand '{files}' bestaat niet.",
    "Cannot read '{files}'." => "Kan bestand '{files}' niet lezen.",
    "Cannot copy '{files}'." => "Kan bestand '{files}' niet kopiëren.",
    "Cannot move '{files}'." => "Kan bestand '{files}' niet verplaatsen.",
    "Cannot delete '{files}'." => "Kan bestand '{files}' niet verwijderen.",
    ...
    "This files is already added to the Clipboard." => "Dit bestand was reeds toegevoegd aan het klembord.",
    ...
    "A files or folder with that name already exists." => "Er bestaat reeds een bestand of map met die naam.",
    ...
    "New files name:" => "Nieuwe bestandsnaam:",
    "Upload" => "Upload",
    "Refresh" => "Verversen",
    ...
    "Date" => "Datum",
    "Descending" => "Aflopend",
    "Uploading files..." => "Bestand uploaden...",
    ...
    "Uploading files {number} of {count}... {progress}" => "Bestand {number} van de {count} aan het uploaden... {progress}",
