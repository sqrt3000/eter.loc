...
/** Ukrainian localization files for KCFinder
...
$lang = array(
    ...
    "Cannot move uploaded files to target folder." => "Неможливо перемістити завантажений файл в папку призначення.",
    "Unknown error." => "Невідома помилка.",
    "The uploaded files exceeds {size} bytes." => "Завантажений файл перевищує розмір {size} байтів.",
    "The uploaded files was only partially uploaded." => "Завантажений файл було завантажено лише частково.",
    "No files was uploaded." => "Файл не було завантажено",
    "Missing a temporary folder." => "Тимчасова папка не існує.",
    "Failed to write files." => "Неможливо записати файл.",
    "Denied files extension." => "Файли цього типу заборонені для завантаження.",
    ...
    "Incorrect .htaccess files. Cannot rewrite it!" => "Неправильний файл .htaccess. Неможливо перезаписати!",
    ...
    "Please enter new files name." => "Вкажіть нову назву файла",
    "Unallowable characters in files name." => "Недопустимі символи в назві файлу.",
    "File name shouldn't begins with '.'" => "Назва файла не може починатися з '.'",
    "Are you sure you want to delete this files?" => "Ви впевнені що хочете вилучити цей файл?",
    ...
    "The files '{files}' does not exist." => "Файл '{files}' не існує.",
    "Cannot read '{files}'." => "Неможливо прочитати файл '{files}'.",
    "Cannot copy '{files}'." => "Неможливо копіювати файл '{files}'.",
    "Cannot move '{files}'." => "Неможливо перемістити файл '{files}'.",
    "Cannot delete '{files}'." => "Неможливо вилучити файл '{files}'.",
    ...
    "This files is already added to the Clipboard." => "Цей файл вже додано в буфер обміну.",
    ...
    "A files or folder with that name already exists." => "Файл або папка з таким іменем вже існують.",
    ...
    "New files name:" => "Нова назва файлу:",
    "Upload" => "Завантажити",
    "Refresh" => "Оновити",
    ...
    "Uploading files..." => "Завантаження файлу...",
    ...
    "Uploading files {number} of {count}... {progress}" => "Завантаження файлу {number} з {count}... {progress}",
