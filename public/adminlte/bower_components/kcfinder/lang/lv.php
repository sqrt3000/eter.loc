...
/** latvian localization files for KCFinder
...
$lang = array(
    ...
    "Cannot move uploaded files to target folder." => "Nevar augšupielādēt failu uz mērķa mapi.",
    "Unknown error." => "Nezināma kļūda.",
    "The uploaded files exceeds {size} bytes." => "Augšupielādētais fails pārsniedz {size} baitus.",
    "The uploaded files was only partially uploaded." => "Augšupielādētais fails tika augšupielādēts tikai daļēji.",
    "No files was uploaded." => "Neviens fails netika augšupielādēts.",
    "Missing a temporary folder." => "Trūkst pagaidu mapē.",
    "Failed to write files." => "Neizdevās ierakstīt failā.",
    "Denied files extension." => "Liegta piekļuve faila paplašinājums.",
    ...
    "Incorrect .htaccess files. Cannot rewrite it!" => "Nepareizs fails .htaccess būs jānoņem. Nevar pārrakstīt!",
    ...
    "Please enter new files name." => "Lūdzu, ievadiet jaunu faila nosaukumu.",
    "Unallowable characters in files name." => "Nepieļaujami rakstzīmes faila nosaukumu.",
    "File name shouldn't begins with '.'" => "Faila nosaukums nedrīkst sāk ar '.'",
    "Are you sure you want to delete this files?" => "Vai tiešām vēlaties izdzēst šo failu?",
    ...
    "The files '{files}' does not exist." => "Fails' {files} 'nepastāv.",
    "Cannot read '{files}'." => "Nevar nolasīt '{files}'.",
    "Cannot copy '{files}'." => "Nevar kopēt '{files}'.",
    "Cannot move '{files}'." => "Nevar pārvietot '{files}'.",
    "Cannot delete '{files}'." => "Nevar izdzēst '{files}'.",
    "Cannot delete the folder." => "Nevar izdzēst mapi.",
    "Click to remove from the Clipboard" => "Noklikšķiniet, lai noņemtu no starpliktuves",
    "This files is already added to the Clipboard." => "Šis fails jau ir pievienots starpliktuvē.",
    ...
    "A files or folder with that name already exists." => "Fails vai mape ar šādu nosaukumu jau pastāv.",
    ...
    "New files name:" => "Jauns faila nosaukums:",
    ...
    "Uploading files..." => "... faila augšupielāde",
    ...
    "Uploading files {number} of {count}... {progress}" => "Augšupielādējot failu {number} no {count}... {progress}",
