...
/** Portuguese localization files for KCFinder
...
$lang = array(
    ...
    "O ficheiro '{files}' não existe.",

    "Cannot read '{files}'." =>
    "Não pode ler '{files}'.",

    "Cannot copy '{files}'." =>
    "Não pode copiar '{files}'.",

    "Cannot move '{files}'." =>
    "Não pode mover '{files}'.",

    "Cannot delete '{files}'." =>
    "Não pode apagar '{files}'.",
    ...
    "New files name:" => "Nome do ficheiro:",
    ...
    "Date" => "Data",
    "Descending" => "",
    "Uploading files..." => "Carregando ficheiro...",
