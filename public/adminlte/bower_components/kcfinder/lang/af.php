...
/** Afrikaans localization files for KCFinder
  */
...
$lang = array(
    ...
    "Unallowed characters in files name." =>
    ...
    "Die lêer '{files}' bestaan ​​nie.",

    "Cannot read '{files}'." =>
    "Kan nie '{files}' lees nie.",

    "Cannot copy '{files}'." =>
    "Kan nie '{files}' kopieer nie.",

    "Cannot move '{files}'." =>
    "Kan nie '{files}' beweeg nie.",

    "Cannot delete '{files}'." =>
    "Kan nie '{files}' verwyder .",
    ...
    "Date" => "Datum",
    "Descending" => "Aflopend",
    "Uploading files..." => "Lêer Besig Met Oplaai...",
