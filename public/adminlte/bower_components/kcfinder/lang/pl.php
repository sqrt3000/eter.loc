...
/** Polish localization files for KCFinder
...
$lang = array(
    ...
    "Cannot move uploaded files to target folder." => "Nie można przenieść wysłanego pliku do folderu plików wysłanych.",
    "Unknown error." => "Nieokreślony błąd.",
    "The uploaded files exceeds {size} bytes." => "Wysyłany plik przekroczył rozmiar {size} bajtów",
    "The uploaded files was only partially uploaded." => "Wysyłany plik nie został przesłany w całości.",
    "No files was uploaded." => "Żaden plik nie został przesłany",
    "Missing a temporary folder." => "Brak katalogu domyślnego.",
    "Failed to write files." => "Błąd zapisu pliku.",
    "Denied files extension." => "Niedozwolone rozszerzenie pliku.",
    ...
    "Incorrect .htaccess files. Cannot rewrite it!" => "Nie prawidłowy plik .htaccess. Nie można go zapisać!",
    ...
    "Please enter new files name." => "Proszę podać nową nazwę pliku",
    "Unallowable characters in files name." => "Nie dozwolony znak w nazwie pliku.",
    "File name shouldn't begins with '.'" => "Nazwa pliku nie powinna zaczynać się od '.'",
    "Are you sure you want to delete this files?" => "Czy jesteś pewien, że chcesz skasować ten plik?",
    ...
    "The files '{files}' does not exist." => "Plik {files} nie istnieje.",
    "Cannot read '{files}'." => "Nie można odczytać pliku '{files}'.",
    "Cannot copy '{files}'." => "Nie można skopiować pliku '{files}'.",
    "Cannot move '{files}'." => "Nie można przenieść pliku '{files}'.",
    "Cannot delete '{files}'." => "Nie można usunąć pliku '{files}'.",
    "Cannot delete the folder." => "Nie można usunąć katalogu.",
    "Click to remove from the Clipboard" => "Kliknij aby usunąć ze Schowka",
    "This files is already added to the Clipboard." => "Ten plik już został dodany do Schowka.",
    ...
    "A files or folder with that name already exists." => "Plik lub katalog o tej nazwie już istnieje.",
    ...
    "New files name:" => "Nowa nazwa pliku:",
    "Upload" => "Wyślij",
    "Refresh" => "Odśwież",
    "Settings" => "Ustawienia",
    ...
    "Date" => "Data",
    "Descending" => "Malejąco",
    "Uploading files..." => "Wysyłanie pliku...",
    ...
    "Uploading files {number} of {count}... {progress}" => "Wysyłanie pliku nr {number} spośród {count} ... {progress}",
