...
/** Norwegian localization files for KCFinder
...
$lang = array(
    ...
    "Filen '{files}' finnes ikke.",

    "Cannot read '{files}'." =>
    "Kan ikke lese '{files}'.",

    "Cannot copy '{files}'." =>
    "Kan ikke kopiere '{files}'.",

    "Cannot move '{files}'." =>
    "Kan ikke flytte '{files}'.",
    ...
    "Date" => "Dato",
    "Descending" => "Synkende",
    "Uploading files..." => "Laster opp fil...",
