...
/** German localization files for KCFinder
...
$lang = array(
    ...
    "Cannot move uploaded files to target folder." => "Kann hochgeladene Datei nicht in den Zielordner verschieben.",
    "Unknown error." => "Unbekannter Fehler.",
    "The uploaded files exceeds {size} bytes." => "Die hochgeladene Datei überschreitet die erlaubte Dateigröße von {size} bytes.",
    "The uploaded files was only partially uploaded." => "Die Datei wurde nur teilweise hochgeladen.",
    "No files was uploaded." => "Keine Datei hochgeladen.",
    "Missing a temporary folder." => "Temporärer Ordner fehlt.",
    "Failed to write files." => "Fehler beim schreiben der Datei.",
    "Denied files extension." => "Die Dateiendung ist nicht erlaubt.",
    ...
    "Incorrect .htaccess files. Cannot rewrite it!" => "Falsche .htaccess Datei. Die Datei kann nicht geschrieben werden",
    ...
    "Please enter new files name." => "Bitte gib einen neuen Dateinamen an.",
    "Unallowable characters in files name." => "Der Dateiname enthält unerlaubte Zeichen",
    "File name shouldn't begins with '.'" => "Dateinamen sollten nicht mit '.' beginnen.",
    "Are you sure you want to delete this files?" => "Willst Du die Datei wirklich löschen?",
    ...
    "The files '{files}' does not exist." => "Die Datei '{files}' existiert nicht.",
    "Cannot read '{files}'." => "Kann Datei '{files}' nicht lesen.",
    "Cannot copy '{files}'." => "Kann Datei '{files}' nicht kopieren.",
    "Cannot move '{files}'." => "Kann Datei '{files}' nicht verschieben.",
    "Cannot delete '{files}'." => "Kann Datei '{files}' nicht löschen.",
    ...
    "This files is already added to the Clipboard." => "Diese Datei wurde bereits der Zwischenablage hinzugefügt.",
    ...
    "A files or folder with that name already exists." => "Eine Datei oder ein Ordner mit dem Namen existiert bereits.",
    ...
    "New files name:" => "Neuer Dateiname:",
    "Upload" => "Hochladen",
    ...
    "Uploading files..." => "Lade Datei hoch...",
    ...
    "Uploading files {number} of {count}... {progress}" => "Lade Datei {number} von {count} hoch ... {progress}",
