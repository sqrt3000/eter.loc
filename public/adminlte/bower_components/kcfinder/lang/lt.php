...
/** Lithuanian localization files for KCFinder
...
$lang = array(
    ...
    "Cannot move uploaded files to target folder." => "Nepavyko įkelti failo į reikiamą katalogą.",
    "Unknown error." => "Nežinoma klaida.",
    "The uploaded files exceeds {size} bytes." => "Įkeliamas failas viršija {size} baitų(-us).",
    "The uploaded files was only partially uploaded." => "Failas buvo tik dalinai įkeltas.",
    "No files was uploaded." => "Failas nebuvo įkeltas.",
    "Missing a temporary folder." => "Nėra laikino katalogo.",
    "Failed to write files." => "Nepavyko įrašyti failo.",
    "Denied files extension." => "Draudžiama įkelti šio tipo failus.",
    ...
    "Incorrect .htaccess files. Cannot rewrite it!" => "Blogas .htaccess failas. Nepavyko jo perrašyti",
    ...
    "Please enter new files name." => "Įveskite failo pavadinimą.",
    "Unallowable characters in files name." => "Failo pavadinime yra neleistinų simbolių",
    "File name shouldn't begins with '.'" => "Failo pavadinimas negali prasidėti '.'",
    "Are you sure you want to delete this files?" => "Ar tikrai ištrinti šį failą?",
    ...
    "The files '{files}' does not exist." => "Failas '{files}' neegzistuoja.",
    "Cannot read '{files}'." => "Nepavyko atidaryti '{files}' failo.",
    "Cannot copy '{files}'." => "Nepavyko nukopijuoti '{files}' failo.",
    "Cannot move '{files}'." => "Nepavyko perkelti '{files}' failo.",
    "Cannot delete '{files}'." => "Nepavyko ištrinti '{files}' failo.",
    ...
    "This files is already added to the Clipboard." => "Šis failas jau įkeltas į laikinąją atmintį.",
    ...
    "A files or folder with that name already exists." => "Failas arba katalogas tokiu pavadinimu jau egzistuoja.",
    ...
    "New files name:" => "Naujo failo pavadinimas:",
    "Upload" => "Įkelti",
    "Refresh" => "Atnaujinti",
    "Settings" => "Nustatymai",
    "Maximize" => "Padidinti",
    ...
    "Uploading files..." => "Įkeliamas failas...",
    ...
    "Uploading files {number} of {count}... {progress}" => "Įkeliamas {number} failas iš {count}... {progress}",
