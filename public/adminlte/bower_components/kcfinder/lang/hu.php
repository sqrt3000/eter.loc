...
/** Hungarian localization files for KCFinder
...
$lang = array(
    ...
    "Cannot move uploaded files to target folder." => "Nem lehet áthelyezni a feltöltött fájlt a célkönyvtárba.",
    "Unknown error." => "Ismeretlen hiba.",
    "The uploaded files exceeds {size} bytes." => "A feltöltött fájl mérete meghaladja a {size} bájtot.",
    "The uploaded files was only partially uploaded." => "A feltöltendő fájl csak részben sikerült feltölteni.",
    "No files was uploaded." => "Nem történt fájlfeltöltés.",
    "Missing a temporary folder." => "Hiányzik az ideiglenes könyvtár.",
    "Failed to write files." => "Nem sikerült a fájl írása.",
    "Denied files extension." => "Tiltott fájlkiterjesztés.",
    ...
    "Incorrect .htaccess files. Cannot rewrite it!" => "Hibás .htaccess fájl. Nem lehet írni.",
    ...
    "Please enter new files name." => "Kérem adja meg az új fájl nevét.",
    "Unallowable characters in files name." => "Meg nem engedett karakter(ek) a fájl nevében.",
    "File name shouldn't begins with '.'" => "Fájlnév nem kezdődhet '.'-tal",
    "Are you sure you want to delete this files?" => "Biztos benne, hogy törölni kívánja ezt a fájlt?",
    ...
    "The files '{files}' does not exist." => "A '{files}' fájl nem létezik.",
    "Cannot read '{files}'." => "A '{files}' fájlt nem lehet olvasni.",
    "Cannot copy '{files}'." => "A '{files}' fájlt nem lehet másolni.",
    "Cannot move '{files}'." => "A '{files}' fájlt nem lehet áthelyezni.",
    "Cannot delete '{files}'." => "A '{files}' fájlt nem lehet törölni.",
    ...
    "This files is already added to the Clipboard." => "Ezt a fájlt már hozzáadta a vágólaphoz.",
    ...
    "A files or folder with that name already exists." => "Egy fájl vagy könyvtár már létezik ugyan ezzel a névvel.",
    ...
    "Date" => "Datum",
    "Descending" => "Csökkenő",
    "Uploading files..." => "Fájl feltöltése...",
    ...
    "Uploading files {number} of {count}... {progress}" => "A(z) {number}. fájl feltöltése (összesen {count}) ... {progress}",
