...
$lang = array(
    ...
    "Cannot move uploaded files to target folder." => "ファイルを移動できません。",
    "Unknown error." => "原因不明のエラーです。",
    "The uploaded files exceeds {size} bytes." => "アップロードしたファイルは {size} バイトを越えました。",
    "The uploaded files was only partially uploaded." => "アップロードしたファイルは、一部のみ処理されました。",
    "No files was uploaded." => "ファイルはありません。",
    "Missing a temporary folder." => "tempフォルダが見つかりません。",
    "Failed to write files." => "ファイルの書き込みに失敗しました。",
    "Denied files extension." => "このファイルは扱えません。",
    ...
    "Incorrect .htaccess files. Cannot rewrite it!" => "不正な .htaccess ファイルです。再編集できません!",
    ...
    "Please enter new files name." => "新しいファイル名を入力して下さい。",
    "Unallowable characters in files name." => "ファイル名に使用できない文字が含まれています。",
    "File name shouldn't begins with '.'" => "ファイル名は「. 」で始めることはできません。",
    "Are you sure you want to delete this files?" => "このファイルを本当に削除してもよろしいですか?",
    ...
    "The files '{files}' does not exist." => "ファイル「{files}」は存在しません。",
    "Cannot read '{files}'." => "「{files}」を読み取れません。",
    "Cannot copy '{files}'." => "「{files}」をコピーできません。",
    "Cannot move '{files}'." => "「{files}」を移動できません。",
    "Cannot delete '{files}'." => "「{files}」を削除できません。",
    "Cannot delete the folder." => "フォルダを削除できません",
    "Click to remove from the Clipboard" => "クリップボードから削除する",
    "This files is already added to the Clipboard." => "このファイルは既にクリップボードに追加されています。",
    ...
    "A files or folder with that name already exists." => "その名前のファイル、またはフォルダは既に存在します。",
    ...
    "Uploading files {number} of {count}... {progress}" => "ファイルをアップロード中（{number}/{count}）... {progress}",
