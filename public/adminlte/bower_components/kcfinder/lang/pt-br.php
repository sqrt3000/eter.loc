...
/** Portugues Brasil localization files for KCFinder
...
$lang = array(
    ...
    "Cannot move uploaded files to target folder." => "Não é poss&iacutevel mover o arquivo enviado para a pasta de destino.",
    "Unknown error." => "Erro desconhecido.",
    "The uploaded files exceeds {size} bytes." => "O arquivo enviado excede {size} bytes.",
    "The uploaded files was only partially uploaded." => "O arquivo enviado foi apenas parcialmente carregado.",
    "No files was uploaded." => "Nenhum arquivo foi transferido.",
    "Missing a temporary folder." => "Faltando uma pasta temporária.",
    "Failed to write files." => "Falha ao gravar arquivo.",
    "Denied files extension." => "Extensão de arquivo não permitida.",
    ...
    "Incorrect .htaccess files. Cannot rewrite it!" => "Arquivo '.htaccess' incorreto. Não é poss&iacutevel alterar.",
    ...
    "Please enter new files name." => "Por favor, digite o novo nome de arquivo.",
    "Unallowable characters in files name." => "Caracteres no nome do arquivo não Autorizado.",
    "File name shouldn't begins with '.'" => "O nome da pasta não deve começar por '.'.",
    "Are you sure you want to delete this files?" => "Tem a certeza de que deseja excluir este arquivo?",
    ...
    "The files '{files}' does not exist." => "O arquivo '{files}' não existe.",
    "Cannot read '{files}'." => "Não é poss&iacutevel ler '{files}'.",
    "Cannot copy '{files}'." => "Não é poss&iacutevel copiar '{files}'.",
    "Cannot move '{files}'." => "Não é poss&iacutevel mover '{files}'.",
    "Cannot delete '{files}'." => "Não é poss&iacutevel deletar '{files}'.",
    ...
    "This files is already added to the Clipboard." => "Este arquivo já foi adicionado à área de transferência.",
    ...
    "A files or folder with that name already exists." => "Já existe um arquivo ou pasta com esse nome.",
    ...
    "New files name:" => "Novo nome do arquivo:",
    ...
    "Uploading files..." => "Carregando arquivo...",
    ...
    "Uploading files {number} of {count}... {progress}" => "Enviando arquivo {number} de {count}... {progress}",
