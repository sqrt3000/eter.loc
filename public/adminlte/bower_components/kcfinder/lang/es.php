...
/** Spanish localization files for KCFinder
...
$lang = array(
    ...
    "Cannot move uploaded files to target folder." => "No puede mover archivos al directorio de destino.",
    "Unknown error." => "Error desconocido.",
    "The uploaded files exceeds {size} bytes." => "El archivo excede el tamaño permitido ({size} bytes).",
    "The uploaded files was only partially uploaded." => "El archivo solo fué parcialmente cargado.",
    "No files was uploaded." => "El archivo no fué cargado.",
    "Missing a temporary folder." => "No se puede encontrar el directorio temporal.",
    "Failed to write files." => "No se pudo crear el archivo.",
    "Denied files extension." => "Extensión de archivo denegada.",
    ...
    "Incorrect .htaccess files. Cannot rewrite it!" => "Archivo .htaccess incorrecto. ¡No puede sobreescribirlo!",
    ...
    "Please enter new files name." => "Por favor introduzca el nuevo nombre del archivo.",
    "Unallowable characters in files name." => "Carácteres inválidos en el nombre de archivo.",
    "File name shouldn't begins with '.'" => "El nombre de archivo no puede comenzar con punto '.'",
    "Are you sure you want to delete this files?" => "Esta seguro de que desea borrar este archivo?",
    ...
    "The files '{files}' does not exist." => "El archivo '{files}' no existe.",
    "Cannot read '{files}'." => "No se puede leer '{files}'.",
    "Cannot copy '{files}'." => "No se puede copiar '{files}'.",
    "Cannot move '{files}'." => "No se puede mover '{files}'.",
    "Cannot delete '{files}'." => "No se puede borrar '{files}'.",
    ...
    "This files is already added to the Clipboard." => "Este archivo ya fué agregado al portapapeles.",
    ...
    "A files or folder with that name already exists." => "Existe una carpeta o archivo con el mismo nombre.",
    ...
    "New files name:" => "Nuevo nombre de archivo:",
    "Upload" => "Cargar",
    "Refresh" => "Refrescar",
    ...
    "Uploading files..." => "Cargando archivo...",
    ...
    "Uploading files {number} of {count}... {progress}" => "Cargando archivo {number} de {count}... {progress}",
