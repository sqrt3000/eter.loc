...
/** Slovak localization files for KCFinder
...
$lang = array(
    ...
    "Cannot move uploaded files to target folder." => "Nie je možné presunúť súbor do zvoleného adresára.",
    "Unknown error." => "Neznáma chyba.",
    "The uploaded files exceeds {size} bytes." => "Nahratý súbor presahuje {size} bytov.",
    "The uploaded files was only partially uploaded." => "Nahratý súbor bol nahraný len čiastočne.",
    "No files was uploaded." => "Žiadný súbor nebol nahraný na server.",
    "Missing a temporary folder." => "Chyba dočasný adresár.",
    "Failed to write files." => "Súbor sa nepodarilo uložiť.",
    "Denied files extension." => "Nepodporovaný typ súboru.",
    ...
    "Incorrect .htaccess files. Cannot rewrite it!" => "Chybný súbor .htaccess. Súbor nemožno prepísať!",
    ...
    "Please enter new files name." => "Vložte prosím nové meno súboru.",
    "Unallowable characters in files name." => "Nepovolené znaky v názve súboru.",
    "File name shouldn't begins with '.'" => "Názov súboru nesmie začínať znakom '.'",
    "Are you sure you want to delete this files?" => "Ste si istý že chcete vymazať tento súbor?",
    ...
    "The files '{files}' does not exist." => "Tento súbor '{files}' neexistuje.",
    "Cannot read '{files}'." => "Nie je možné načítať '{files}'.",
    "Cannot copy '{files}'." => "Nie je možné kopírovať '{files}'.",
    "Cannot move '{files}'." => "Nie je možné presunúť '{files}'.",
    "Cannot delete '{files}'." => "Nie je možné vymazať '{files}'.",
    ...
    "This files is already added to the Clipboard." => "Tento súbor je už v schránke uložený.",
    ...
    "A files or folder with that name already exists." => "Soubor alebo adresár s takovým menom už existuje.",
    ...
    "New files name:" => "Nový názov súboru:",
    "Upload" => "Nahrať",
    "Refresh" => "Obnoviť",
    "Settings" => "Nastavenia",
    ...
    "Uploading files {number} of {count}... {progress}" => "Nahrávam súbor {number} z {count}... {progress}",
