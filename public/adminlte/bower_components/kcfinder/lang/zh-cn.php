...
/** Chinese Simplified localization files for KCFinder
  * author: yutuo
  * country: China
...
$lang = array(
    ...
    "Cannot move uploaded files to target folder." => "无法移动上传文件到指定文件夹。",
    "Unknown error." => "发生不可预知异常。",
    "The uploaded files exceeds {size} bytes." => "文件大小超过{size}字节。",
    "The uploaded files was only partially uploaded." => "文件未完全上传。",
    "No files was uploaded." => "文件未上传。",
    "Missing a temporary folder." => "临时文件夹不存在。",
    "Failed to write files." => "写入文件失败。",
    "Denied files extension." => "禁止的文件扩展名。",
    ...
    "Incorrect .htaccess files. Cannot rewrite it!" => "文件.htaccess错误，无法重写。",
    ...
    "Please enter new files name." => "请输入新文件名。",
    "Unallowable characters in files name." => "文件名含有禁止字符。",
    "File name shouldn't begins with '.'" => "文件名不能以点（.）为首字符。",
    "Are you sure you want to delete this files?" => "是否确认删除该文件？",
    ...
    "The files '{files}' does not exist." => "文件{files}不存在。",
    "Cannot read '{files}'." => "无法读取文件{files}。",
    "Cannot copy '{files}'." => "无法复制文件{files}。",
    "Cannot move '{files}'." => "无法移动文件{files}。",
    "Cannot delete '{files}'." => "无法删除文件{files}。",
    "Cannot delete the folder." => "无法删除该文件夹。",
    "Click to remove from the Clipboard" => "点击从剪贴板删除",
    "This files is already added to the Clipboard." => "文件已复制到剪贴板。",
    ...
    "A files or folder with that name already exists." => "文件或文件夹已存在。",
    ...
    "Uploading files {number} of {count}... {progress}" => "正在上传文件{number} / {count}... {progress}",
