...
$lang = array(
    ...
    "Cannot move uploaded files to target folder." => "Kan ikke flytte fil til destinations mappe.",
    "Unknown error." => "Ukendt fejl.",
    "The uploaded files exceeds {size} bytes." => "Den uploadede fil overskrider {size} bytes.",
    "The uploaded files was only partially uploaded." => "Den uploadede fil blev kun delvist uploadet.",
    "No files was uploaded." => "Ingen fil blev uploadet.",
    "Missing a temporary folder." => "Mangler en midlertidig mappe.",
    "Failed to write files." => "Kunne ikke skrive fil.",
    "Denied files extension." => "Nægtet filtypenavn.",
    ...
    "Incorrect .htaccess files. Cannot rewrite it!" => "Forkert .htaccess fil. Kan ikke omskrive den!",
    ...
    "Please enter new files name." => "Indtast venligst nyt filnavn.",
    "Unallowable characters in files name." => "Ugyldige tegn i filens navn",
    "File name shouldn't begins with '.'" => "Filnavn bør ikke begynde med '.'",
    "Are you sure you want to delete this files?" => "Er du sikker på du vil slette denne fil?",
    ...
    "The files '{files}' does not exist." => "Filen '{files}' eksisterer ikke.",
    "Cannot read '{files}'." => "Kan ikke læse '{files}'.",
    "Cannot copy '{files}'." => "Kan ikke kopiere '{files}'.",
    "Cannot move '{files}'." => "Kan ikke flytte '{files}'.",
    "Cannot delete '{files}'." => "Kan ikke slette '{files}'.",
    "Cannot delete the folder." => "Kan ikke slette mappen.",
    "Click to remove from the Clipboard" => "Klik for at fjerne fra udklipsholderen.",
    "This files is already added to the Clipboard." => "Denne fil er allerede føjet til udklipsholderen.",
    ...
    "A files or folder with that name already exists." => "En fil eller mappe med det navn findes allerede.",
    ...
    "Uploading files {number} of {count}... {progress}" => "Uploader fil {number} af {count} ... {progress}",
