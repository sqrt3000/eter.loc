...
/** vi localization files for KCFinder
...
$lang = array(
    ...
    "Cannot move uploaded files to target folder." => "Không thể tải lên thư mục đích",
    "Unknown error." => "Lỗi không xác định",
    "The uploaded files exceeds {size} bytes." => "Tập tin tải lên lớn hơn {size}",
    "The uploaded files was only partially uploaded." => "Các tập tin chỉ được tải lên một phần",
    "No files was uploaded." => "Không có tập tin được tải lên",
    "Missing a temporary folder." => "Không thấy thư mục tạm",
    "Failed to write files." => "Không thể ghi",
    "Denied files extension." => "Phần mở rộng không được phép",
    ...
    "Incorrect .htaccess files. Cannot rewrite it!" => "không thể ghi tập tin .htaccess",
    ...
    "Please enter new files name." => "Vui lòng nhập tên tập tin",
    "Unallowable characters in files name." => "Tên tập tin chứa những ký tự không được phép",
    "File name shouldn't begins with '.'" => "Tập tin không thể bắt đầu bằng '.'",
    "Are you sure you want to delete this files?" => "Bạn có chắc bạn muốn xóa tập tin này?",
    ...
    "The files '{files}' does not exist." => "Tập tin '{files}' đã có",
    "Cannot read '{files}'." => "Không thể đọc '{files}'.",
    "Cannot copy '{files}'." => "Không thể sao chép '{files}'.",
    "Cannot move '{files}'." => "Không thể di chuyển '{files}'.",
    "Cannot delete '{files}'." => "Không thể xóa tập tin '{files}'.",
    "Cannot delete the folder." => "Không thể xóa thư mục",
    "Click to remove from the Clipboard" => "Không thể xóa từ Bộ nhớ",
    "This files is already added to the Clipboard." => "Tập tin đã có trong bộ nhớ",
    ...
    "A files or folder with that name already exists." => "Đã tồn tại tập tin hoặc thư mục với tên này",
    ...
    "New files name:" => "Tên mới của tập tin",
    "Upload" => "Tải lên",
    "Refresh" => "Làm mới",
    "Settings" => "Cấu hình",
    "Maximize" => "Tối đa",
    ...
    "Uploading files {number} of {count}... {progress}" => "Đang tải tập tin thứ {number} của {count}... {progress}",
