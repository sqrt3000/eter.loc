...
/** Greek  localization files for KCFinder
...
$lang = array(
    ...
    "Cannot move uploaded files to target folder." => "Το αρχείο δε μπορεί να μεταφερθεί στο φάκελο προορισμού.",
    "Unknown error." => "Άγνωστο σφάλμα.",
    "The uploaded files exceeds {size} bytes." => "Το αρχείο υπερβαίνει το μέγεθος των {size} bytes.",
    "The uploaded files was only partially uploaded." => "Ένα μόνο μέρος του αρχείου ανέβηκε.",
    "No files was uploaded." => "Κανένα αρχείο δεν ανέβηκε.",
    "Missing a temporary folder." => "Λείπει ο φάκελος των προσωρινών αρχείων.",
    "Failed to write files." => "Σφάλμα στη τροποποίηση του αρχείου.",
    "Denied files extension." => "Δεν επιτρέπονται αυτού του είδους αρχεία.",
    ...
    "Incorrect .htaccess files. Cannot rewrite it!" => "Εσφαλμένο αρχείο .htaccess. Αδύνατη η τροποποίησή του!",
    ...
    "Please enter new files name." => "Παρακαλούμε εισάγετε ένα νέο όνομα αρχείου.",
    "Unallowable characters in files name." => "Μη επιτρεπτοί χαρακτήρες στο όνομα αρχείου.",
    "File name shouldn't begins with '.'" => "Το όνομα του αρχείου δεν πρέπει να αρχίζει με '.'",
    "Are you sure you want to delete this files?" => "Σίγουρα θέλετε να διαγράψετε αυτό το αρχείο;",
    ...
    "The files '{files}' does not exist." => "Το αρχείο '{files}' δεν υπάρχει.",
    "Cannot read '{files}'." => "Αρχείο '{files}' μη αναγνώσιμο.",
    "Cannot copy '{files}'." => "Αδύνατη η αντιγραφή του '{files}'.",
    "Cannot move '{files}'." => "Αδύνατη η μετακίνηση του '{files}'.",
    "Cannot delete '{files}'." => "Αδύνατη η διαγραφή του '{files}'.",
    ...
    "This files is already added to the Clipboard." => "Αυτό το αρχείο βρίσκεται ήδη στο Πρόχειρο.",
    ...
    "A files or folder with that name already exists." => "Ένα αρχείο ή φάκελος με αυτό το όνομα υπάρχει ήδη.",
    ...
    "New files name:" => "Νέο όνομα αρχείου:",
    "Upload" => "Ανέβασμα",
    "Refresh" => "Ανανέωση",
    "Settings" => "Ρυθμίσεις",
    ...
    "Date" => "Ημερομηνία",
    "Descending" => "Φθίνουσα",
    "Uploading files..." => "Το αρχείο ανεβαίνει...",
    ...
    "Uploading files {number} of {count}... {progress}" => "Ανέβασμα αρχείου {number} από {count}... {progress}",
