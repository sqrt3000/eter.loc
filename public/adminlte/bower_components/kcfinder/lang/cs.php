...
/** Czech localization files for KCFinder
...
$lang = array(
    ...
    "Cannot move uploaded files to target folder." => "Nelze přesunout soubor do určeného adresáře.",
    "Unknown error." => "Neznámá chyba.",
    "The uploaded files exceeds {size} bytes." => "Nahraný soubor přesahuje {size} bytů.",
    "The uploaded files was only partially uploaded." => "Nahraný soubor byl nahrán pouze částečně.",
    "No files was uploaded." => "Žádný soubor nebyl nahrán na server.",
    "Missing a temporary folder." => "Chybí dočasný adresář.",
    "Failed to write files." => "Soubor se nepodařilo se uložit.",
    "Denied files extension." => "Nepodporovaný typ souboru.",
    ...
    "Incorrect .htaccess files. Cannot rewrite it!" => "Chybný soubor .htaccess. Soubor nelze přepsat!",
    ...
    "Please enter new files name." => "Vložte prosím nové jméno souboru.",
    "Unallowable characters in files name." => "Nepovolené znaky v názvu souboru.",
    "File name shouldn't begins with '.'" => "Název soubor nesmí začínat znakem '.'",
    "Are you sure you want to delete this files?" => "Jste si jistý že chcete smazat tento soubor?",
    ...
    "The files '{files}' does not exist." => "Tento soubor '{files}' neexistuje.",
    "Cannot read '{files}'." => "Nelze načíst '{files}'.",
    "Cannot copy '{files}'." => "Nelze kopírovat '{files}'.",
    "Cannot move '{files}'." => "Nelze přesunout '{files}'.",
    "Cannot delete '{files}'." => "Nelze smazat '{files}'.",
    "Cannot delete the folder." => "Adresář nelze smazat.",
    "Click to remove from the Clipboard" => "Klikněte pro odstranění ze schránky",
    "This files is already added to the Clipboard." => "Tento soubor je již ve schránce vložen.",
    ...
    "A files or folder with that name already exists." => "Soubor nebo adresář s takovým jménem již existuje.",
    ...
    "New files name:" => "Nový název souboru:",
    "Upload" => "Nahrát",
    "Refresh" => "Obnovit",
    "Settings" => "Nastavení",
    ...
    "Uploading files {number} of {count}... {progress}" => "Nahrávám soubor {number} z {count}... {progress}",
