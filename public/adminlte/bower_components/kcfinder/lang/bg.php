...
/** Bulgarian localization files for KCFinder
...
$lang = array(
    ...
    "Cannot move uploaded files to target folder." =>
    "Файлът не може да се премести в целевата папка.",

    "Unknown error." =>
    "Непозната грешка.",

    "The uploaded files exceeds {size} bytes." =>
    "Каченият файл надхвърля {size} байта.",

    "The uploaded files was only partially uploaded." =>
    ...
    "Incorrect .htaccess files. Cannot rewrite it!" =>
    ...
    "Please enter new files name." =>
    "Моля въведете ново име на файла",

    "Unallowable characters in files name." =>
    ...
    "The files '{files}' does not exist." =>
    "Фаълът '{files}' не съществува.",

    "Cannot read '{files}'." =>
    "Файлът '{files}' не може да бъде прочетен.",

    "Cannot copy '{files}'." =>
    "Файлът '{files}' не може да бъде копиран.",

    "Cannot move '{files}'." =>
    "Файлът '{files}' не може да бъде преместен.",

    "Cannot delete '{files}'." =>
    "Файлът '{files}' не може да бъде изтрит.",
    ...
    "This files is already added to the Clipboard." =>
    ...
    "A files or folder with that name already exists." =>
    ...
    "New files name:" => "Ново име на файла:",
    ...
    "Uploading files..." => "Файлът се качва...",
    ...
    "Uploading files {number} of {count}... {progress}" =>
