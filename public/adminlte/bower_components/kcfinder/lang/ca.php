...
/** Catalan localization files for KCFinder
  * author: Xevi Fuster
  * country: Catalunya
  */
...
$lang = array(
    ...
    "Cannot move uploaded files to target folder." => "No es pot moure el fitxer pujat al directori destí",
    "Unknown error." => "Error desconegut.",
    "The uploaded files exceeds {size} bytes." => "El fitxer seleccionat excedeix el pes màxim permès ( {size} bytes ).",
    "The uploaded files was only partially uploaded." => "El fitxer seleccionat només s'ha carregat parcialment.",
    "No files was uploaded." => "No s'ha carregat cap fitxer.",
    "Missing a temporary folder." => "Manca un directori temporal.",
    "Failed to write files." => "No s'ha pogut escriure el fitxer.",
    "Denied files extension." => "Extensió de fitxer no permesa.",
    ...
    "Incorrect .htaccess files. Cannot rewrite it!" => "Fitxer .htaccess incorrecte. No es pot reescriure!",
    ...
    "Please enter new files name." => "Si us plau, introduïu el nom del nou fitxer.",
    "Unallowable characters in files name." => "Caràcters no permesos en el nom del fitxer.",
    "File name shouldn't begins with '.'" => "El nom d'un fitxer no hauria de començar amb un punt '.'",
    "Are you sure you want to delete this files?" => "Esteu segur que voleu eliminar aquest fitxer?",
    ...
    "The files '{files}' does not exist." => "El fitxer '{files}' no existeix.",
    "Cannot read '{files}'." => "No s'ha pogut llegir '{files}'.",
    "Cannot copy '{files}'." => "No s'ha pogut copiar '{files}'.",
    "Cannot move '{files}'." => "No s'ha pogut moure '{files}'.",
    "Cannot delete '{files}'." => "No s'ha pogut eliminar '{files}'.",
    ...
    "This files is already added to the Clipboard." => "Aquest arxiu ja es troba al portapapers.",
    ...
    "A files or folder with that name already exists." => "Ja existeix un directori o fitxer amb aquest nom.",
    ...
    "New files name:" => "Nom del nou fitxer:",
    ...
    "Uploading files..." => "Carregant fitxer...",
    ...
    "Uploading files {number} of {count}... {progress}" => "Carregant arxiu {number} de {count}... {progress}",
