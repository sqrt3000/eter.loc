...
/** Romanian localization files for KCFinder
  */
...
$lang = array(
    ...
    "Cannot move uploaded files to target folder." => "Fișierul încărcat nu poate fi mutat în dosarul țintă.",
    "Unknown error." => "Eroare necunoscută.",
    "The uploaded files exceeds {size} bytes." => "Fișierul încărcat depășește {size} biți.",
    "The uploaded files was only partially uploaded." => "Fișierul încărcat a fost încărcat doar parțial.",
    "No files was uploaded." => "Nu a fost încărcat niciun fișier.",
    "Missing a temporary folder." => "Nu există un dosar de fișiere temporare.",
    "Failed to write files." => "Fișierul nu a fost scris.",
    "Denied files extension." => "Extensie de fișier respinsă.",
    ...
    "Incorrect .htaccess files. Cannot rewrite it!" => "Fișier .htacces incorect. Nu poate fi rescris!",
    ...
    "Please enter new files name." => "Vă rugăm să introduceți un nou nume al fișierului.",
    "Unallowable characters in files name." => "Caractere nepermise în numele fișierului.",
    "File name shouldn't begins with '.'" => "Numele fișierului nu ar trebui să înceapă cu '.' ",
    "Are you sure you want to delete this files?" => "Sigur doriți să ștergeți acest fișier?",
    ...
    "The files '{files}' does not exist." => "Fișierul '{files}' nu există.",
    "Cannot read '{files}'." => "Fișierul '{files}' nu poate fi citit.",
    "Cannot copy '{files}'." => "Fișierul '{files}' nu poate fi copiat.",
    "Cannot move '{files}'." => "Fișierul '{files}' nu poate fi mutat.",
    "Cannot delete '{files}'." => "Fișierul '{files}' nu poate fi șters.",
    ...
    "This files is already added to the Clipboard." => "Acest fișier este adăugat deja pe clipboard.",
    ...
    "A files or folder with that name already exists." => "Există deja un fișier sau dosar cu acest nume.",
    ...
    "New files name:" => "Nume nou fișier:",
    "Upload" => "Încărcare",
    ...
    "Uploading files..." => "Încărcare fișier...",
    ...
    "Uploading files {number} of {count}... {progress}" => "Încărcare fișier {number} din {count}... {progress}",
