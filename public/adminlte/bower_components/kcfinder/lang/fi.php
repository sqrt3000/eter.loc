...
/** Finnish localization files for KCFinder
...
$lang = array(
    ...
    "Cannot move uploaded files to target folder." => "Ladattua tiedostoa ei voi siirtää kohdekansioon. ",
    "Unknown error." => "Tuntematon virhe.",
    "The uploaded files exceeds {size} bytes." => "Tiedoston koko ylittää {size} tavua.",
    "The uploaded files was only partially uploaded." => "Valitsemasi tiedosto latautui vain osittain.",
    "No files was uploaded." => "Yhtään tiedostoja ei ladattu.",
    "Missing a temporary folder." => "Puuttuu väliaikainen kansio.",
    "Failed to write files." => "Tiedostoon kirjoitus epäonnistui.",
    "Denied files extension." => "Kielletty tiedostopääte.",
    ...
    "Incorrect .htaccess files. Cannot rewrite it!" => "Virheellinen .htaccess tiedosto. Tiedostoon ei voi kirjoittaa.",
    ...
    "Please enter new files name." => "Kirjoita uusi tiedostonimi.",
    "Unallowable characters in files name." => "Kiellettyjä merkkejä tiedoston nimessä.",
    "File name shouldn't begins with '.'" => "Tiedoston nimi ei voi alkaa '.'",
    "Are you sure you want to delete this files?" => "Haluatko varmasti poistaa tiedoston?",
    ...
    "The files '{files}' does not exist." => "Tiedostoa '{files}' ei ole luotu.",
    "Cannot read '{files}'." => "Tiedostoa '{files}' ei voi lukea.",
    "Cannot copy '{files}'." => "Tiedostoa '{files}' ei voi kopioda.",
    "Cannot move '{files}'." => "Tiedostoa '{files}' ei voi siirtää.",
    "Cannot delete '{files}'." => "Tiedostoa '{files}' ei voi poistaa.",
    "Cannot delete the folder." => "Kansiota ei voi poistaa.",
    "Click to remove from the Clipboard" => "Klikkaa poistaaksesi Leikepöydältä.",
    "This files is already added to the Clipboard." => "Tiedosto on jo lisätty Leikepöydälle.",
    ...
    "A files or folder with that name already exists." => "Tiedosto tai kansio nimellä on jo luoto.",
    ...
    "New files name:" => "Uusi tiedostonimi:",
    "Upload" => "Lataa",
    "Refresh" => "Päivitä",
    "Settings" => "Asetukset",
    "Maximize" => "Koko ruutu",
    ...
    "Date" => "Päiväys",
    "Descending" => "Laskeva",
    "Uploading files..." => "Siirretään tiedostoa...",
    ...
    "Uploading files {number} of {count}... {progress}" => "Siirretään tiedostoa {number}/{count} ... {progress}",
