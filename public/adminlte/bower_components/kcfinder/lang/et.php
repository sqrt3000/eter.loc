...
/** Estonian localization files for KCFinder
...
$lang = array(
    ...
    "Cannot move uploaded files to target folder." => "Üleslaetud faili liigutamine ebaõnnestus.",
    "Unknown error." => "Tundmatu viga.",
    "The uploaded files exceeds {size} bytes." => "Üleslaetud fail on suurem kui lubatud {size} baiti",
    "The uploaded files was only partially uploaded." => "Fail laeti üles ainult osaliselt.",
    "No files was uploaded." => "Faili ei õnnestunud üles laadida.",
    "Missing a temporary folder." => "Failide ajutine kataloog on puudu.",
    "Failed to write files." => "Faili loomine ebaõnnestus.",
    "Denied files extension." => "Faili laiend ei ole lubatud.",
    ...
    "Incorrect .htaccess files. Cannot rewrite it!" => "Vigane .htacess fail. Ümberkirjutamine ebaõnnestus.",
    ...
    "Please enter new files name." => "Sisesta uus faili nimi.",
    "Unallowable characters in files name." => "Keelatud tähemärgid faili nimes.",
    "File name shouldn't begins with '.'" => "Failinimi ei tohi alata punktiga.",
    "Are you sure you want to delete this files?" => "Oled sa kindel, et soovid selle faili kustutada?",
    ...
    "The files '{files}' does not exist." => "Faili '{files}' ei ole olemas.",
    "Cannot read '{files}'." => "Faili '{files}' ei õnnestunud lugeda.",
    "Cannot copy '{files}'." => "Faili '{files}' ei õnnestunud kopeerida.",
    "Cannot move '{files}'." => "Faili '{files}' ei õnnestunud liigutada.",
    "Cannot delete '{files}'." => "Faili '{files}' ei õnnestunud kustutada.",
    "Cannot delete the folder." => "Kataloogi ei saa kustutada.",
    "Click to remove from the Clipboard" => "Kliki, et eemaldada lõikelaualt.",
    "This files is already added to the Clipboard." => "Fail on juba lõikelauale lisatud.",
    ...
    "A files or folder with that name already exists." => "Selle nimega fail/kataloog on juba olemas.",
    ...
    "Uploading files {number} of {count}... {progress}" => "Laen üles faili {number} {count}-st... {progress}",
