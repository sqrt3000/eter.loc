...
/** Hebrew localization files for KCFinder
...
$lang = array(
    ...
    "Cannot move uploaded files to target folder." => "לא ניתן להעביר את הקבצים שהועלו לתקייה שנבחרה.",
    "Unknown error." => "שגיאה לא ידועה.",
    "The uploaded files exceeds {size} bytes." => "הקובץ המועלה עובר את הגודל המקסימלי. ({size} בתים).",
    "The uploaded files was only partially uploaded." => "הקובץ הועלה חלקית.",
    "No files was uploaded." => "לא הועלו קבצים.",
    "Missing a temporary folder." => "חסר תקייה זמנית.",
    "Failed to write files." => "כתיבת הקובץ נכשלה.",
    "Denied files extension." => "סיומת קובץ לא מורשית.",
    ...
    "Incorrect .htaccess files. Cannot rewrite it!" => "קובץ .htaccess לא חוקי, לא ניתן לשכתב קובץ \\זה.",
    ...
    "Please enter new files name." => "אנא הכנס שם לקובץ החדש",
    "Unallowable characters in files name." => "אותיות לא מורשות בשם הקובץ.",
    "File name shouldn't begins with '.'" => "שם קובץ אינו יכול להתחיל בנקודה.",
    "Are you sure you want to delete this files?" => "הנך בטוח שברצונך למחוק קבצים אילו?",
    ...
    "The files '{files}' does not exist." => "הקובץ '{files}' לא קיים.",
    "Cannot read '{files}'." => "לא יכול לפתוח '{files}'.",
    "Cannot copy '{files}'." => "לא יכול להעתיק '{files}'.",
    "Cannot move '{files}'." => "לא יכול להעביר '{files}'.",
    "Cannot delete '{files}'." => "לא יכול למחוק '{files}'.",
    "Cannot delete the folder." => "לא ניתן למחוק את התקייה",
    "Click to remove from the Clipboard" => "לחץ להסיר מהלוח",
    "This files is already added to the Clipboard." => "קובץ זה קיים בלוח.",
    ...
    "A files or folder with that name already exists." => "תקייה/קובץ בשם זה כבר קיימים.",
    ...
    "Uploading files {number} of {count}... {progress}" => "מעלה קובץ {number} מתוך {count}... {progress}",
