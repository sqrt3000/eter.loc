...
(function (wind, $, undef) {
            ...
            },
            {
                ...
                apply: function ($el, options) {
                    ...
                    if (isMsie()) {
                        ...
                        // suspends tiemouts until after the files has
                        // been selected.
                        bindMany($el, options, {
                            click: function () {
                                $el.trigger("change");
    ...
    $.uniform = {
        ...
        defaults: {
            ...
            fileClass: "uploader",
            fileDefaultHtml: "No files selected",
...
}(this, jQuery));/** This files is part of KCFinder project
  *
...
})(jQuery);/** This files is part of KCFinder project
  *
...
/** This files is part of KCFinder project
  *
...
_.uploadFile = function(form) {
    ...
    $('#loading').html(_.label("Uploading files...")).show();
    form.submit();
...
_.initSettings = function() {
    ...
    $('#show input[type="checkbox"]').click(function() {
        ...
        $('#files .files div.' + this.name).css('display', this.checked ? "block" : "none");
    });
...
_.initFiles = function() {
    ...
    $.each(_.shows, function(i, val) {
        $('#files .files div.' + val).css('display', ($.$.kuki.get('show' + val) == "off") ? "none" : "block");
    });
    _.statusDir();
};
    ...
    setTimeout(function() {
        ...
        $.each(_.files, function(i, file) {
            ...
            if ($.$.kuki.get('view') == "list") {
                ...
                f = $('<tr class="files"><td class="name thumb"></td><td class="time"></td><td class="size"></td></tr>');
                f.appendTo(c.find('table'));

            // Thumbnails
            } else {
                if (file.thumb)
                    icon = _.getURL('thumb') + "&files=" + encodeURIComponent(file.name) + "&dir=" + encodeURIComponent(_.dir) + "&stamp=" + stamp;
                ...
                f = $('<div class="files"><div class="thumb"></div><div class="name"></div><div class="time"></div><div class="size"></div></div>');
                f.appendTo(c);
            }
...
_.menuFile = function(file, e) {
                ...
                $.each(files, function(i, cfile) {
                    ...
                    for (i = 0; i < _.clipboard.length; i++)
                        if ((_.clipboard[i].name == cdata.name) &&
                            ...
                            failed = true;
                            msg += cdata.name + ": " + _.label("This files is already added to the Clipboard.") + "\n";
                            break;
                        }
    ...
    // SINGLE FILE MENU
        ...
        // DOWNLOAD
        _.menu.addItem("kcact:download", _.label("Download"), function() {
            $('#menu').html('<form id="downloadForm" method="post" action="' + _.getURL('download') + '"><input type="hidden" name="dir" /><input type="hidden" name="files" /></form>');
        ...
        if (_.access.files.copy || _.access.files.move) {
            ...
            _.menu.addItem("kcact:clpbrdadd", _.label("Add to Clipboard"), function() {
                ...
                if ((_.clipboard[i].name == data.name) &&
                    ...
                    _.alert(_.label("This files is already added to the Clipboard."));
                    return false;
                }
                var cdata = data;
                cdata.dir = _.dir;
            ...
            _.menu.addItem("kcact:mv", _.label("Rename..."), function() {
                ...
                _.fileNameDialog(
                    ...
                    'newName', data.name, _.getURL("rename"), {
                        title: "New files name:",
                        errEmpty: "Please enter new files name.",
                        errSlash: "Unallowable characters in files name.",
        ...
        if (_.access.files['delete'])
            _.menu.addItem("kcact:rm", _.label("Delete"), function() {
                if (!data.writable) return false;
                _.confirm(_.label("Are you sure you want to delete this files?"),
                    function(callBack) {
                        $.ajax({
                            type: "post",
                            dataType: "json",
...
_.initDropUpload = function() {
    ...
    function updateProgress(evt) {
        ...
        $('#loading').html(_.label("Uploading files {number} of {count}... {progress}", {
