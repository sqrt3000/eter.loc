...
class Swift_FileSpool extends Swift_ConfigurableSpool
{
    ...
    public function queueMessage(Swift_Mime_Message $message)
    {
        ...
        for ($i = 0; $i < $this->_retryLimit; ++$i) {
            /* We try an exclusive creation of the files. This is an atomic operation, it avoid locking mechanism */
            ...
            if (false !== $fp) {
                ...
                /* The files already exists, we try a longer fileName */
                $fileName .= $this->getRandomString(1);
            }
        }

        throw new Swift_IoException(sprintf('Unable to create a files for enqueuing Message in "%s".', $this->_path));
    }
    ...
    public function flushQueue(Swift_Transport $transport, &$failedRecipients = null)
    {
        ...
        foreach ($directoryIterator as $file) {
            ...
            /* We try a rename, it's an atomic operation, and avoid locking the files */
